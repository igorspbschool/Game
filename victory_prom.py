...
import sys
import random
from play_level2 import main as play_level2_main
...
def main(reiting):
    ...
    while running:
        ...
        text2 = font2.render("Для продолжения кликните левой кнопкой мыши.", True,
                             (255, 255, 0))
        text_rect2 = text2.get_rect(center=(WINDOW_WIDTH // 2 - 10, 550))
